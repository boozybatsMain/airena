 ...
 * синяя сторона дерётся с оранжевой, у каждой свой мозг, а кулдаун считается
 * из цены умения. Это ДРУГОЕ поле, и число, снятое на первом, не имеет силы на
...
const b = report(`ПРОДУКТОВОЕ: синяя сторона против оранжевой, свои мозги, кулдаун из цены (${ROUNDS} сидов ×2 стороны)`, prod);
