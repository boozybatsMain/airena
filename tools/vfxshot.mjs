 ...
 * после — пустой пол. Поэтому каждый каст снимается сеткой: три глаза
 * (трансляционный, низкий боковой, верхний) на три момента (выход, пик,
 * удержание), и все девять кадров лежат рядом с именем в файле.
 *
...
/* Три глаза. `broadcast` — дистанция и высота решателя боя (13–34 м,
