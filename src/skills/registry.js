...
export const DELIVERIES = table({
  ...
  cone: {
    ...
    doc: 'вблизи, широко, быстро; идёт по земле — прыжок уходит от него',
  },
  bolt: {
  ...
  zone: {
    ...
    doc: 'область, которая работает несколько секунд; лежит на полу — прыжок пропускает один-два срабатывания, но не весь каст',
  },
  dash: {
    id: 'dash', ru: 'рывок', klass: TARGETED, cost: 4,
    silhouette: 'лента рывка за телом',
    windup: 0.18, recover: 0.26, distance: 8.0, needsLos: true,
    doc: 'кастер едет вперёд и бьёт всех по пути; едет по земле — прыжок уходит от него',
  },
  blink: {
  ...
  jump: {
    ...
    doc: 'кастер уходит в воздух: наземные доставки (конус, зона, рывок) проходят под ним, и он уносит с собой скорость отрыва',
  },
});
