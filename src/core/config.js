...
export const BUILD_AXES = {
  hp: { min: 60, max: 460, def: 260, per: 40 },
  maxSpeed: { min: 3.0, max: 8.0, def: 5.5, per: 0.5 },
   ...
   */
  turnRate: { min: 2.5, max: 12.5, def: 7.5, per: 1.0, weight: 0.7 },
  radius: { min: 1.15, max: 1.85, def: 1.5, per: 0.07, inverse: true },
  jumpHeight: { min: 0.8, max: 3.2, def: 2.0, per: 0.24, weight: 0.7 },
};
