 ...
 */
export function runMatch(brains, { seed = 1, record = false, onFrame = null, observer = null, curtainSeconds = 0, kits = null, sizes = null } = {}) {
  const world = createWorld(seed, { curtainSeconds, kits, sizes });
