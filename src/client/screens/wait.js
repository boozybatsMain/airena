...
/* `http` и `rate` приехали сюда 01.09 вместе с ключом, на котором кончились
   деньги: провайдер отвечал 402, экран показывал «попытка засчитана: модель
   ответила», а модель не прочла ни токена. Сверяется гейтом `checkstages`. */
